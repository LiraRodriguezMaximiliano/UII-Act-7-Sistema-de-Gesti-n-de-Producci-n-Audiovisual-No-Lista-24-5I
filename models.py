...
class RolProduccion(models.Model):
...
class ProyectoAudiovisual(models.Model):
    ...
    id_director = models.ForeignKey(MiembroEquipo, on_delete=models.CASCADE)
...
class Escena(models.Model):
    ...
    id_proyecto = models.ForeignKey(ProyectoAudiovisual, on_delete=models.CASCADE)
...
class MaterialGrabado(models.Model):
    ...
    def __str__(self):
        return f"Material {self.id_material} - {self.tipo_material}"
...
class ContratoTalento(models.Model):
    id_contrato = models.AutoField(primary_key=True)
    id_proyecto = models.ForeignKey(ProyectoAudiovisual, on_delete=models.CASCADE)
    id_miembro = models.ForeignKey(MiembroEquipo, on_delete=models.CASCADE)
    ...
    def __str__(self):
        return f"Contrato {self.id_contrato} - {self.id_miembro.nombre}"
```
